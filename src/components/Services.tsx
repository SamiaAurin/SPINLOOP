...
export function Services() {
  return (
    <section
      id="services"
      className="bg-paper px-5 py-24 lg:px-8 lg:py-32"
    >
        ...
        <div className="mt-14 grid items-stretch gap-6 lg:grid-cols-3">
          {services.map((item, i) => (
            <Reveal
              ...
              className="h-full"
            >
              <article className="group flex h-full flex-col overflow-hidden rounded-[1.75rem] border border-line bg-white shadow-[var(--shadow-card)]">
